                                        ...
                                        <div class="overflow-hidden">
                                            <div class="img-wrapper">
                                                <a href="product-page(accordian).html"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/product/6.jpg"
                                ...
                                <div>
                                    <div class="basic-product theme-product-1">
                                        <div class="overflow-hidden">
                                            <div class="img-wrapper">
                                                <a href="product-page(accordian).html"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/product/7.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                    <span>4.5</span>
                                                </div>
                                ...
                                <div>
                                    <div class="basic-product theme-product-1">
                                        <div class="overflow-hidden">
                                            <div class="img-wrapper">
                                                <a href="product-page(accordian).html"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/product/8.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                    <span>4.5</span>
                                                </div>
                                ...
                                <div>
                                    <div class="basic-product theme-product-1">
                                        <div class="overflow-hidden">
                                            <div class="img-wrapper">
                                                <a href="product-page(accordian).html"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/product/10.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                    <span>4.5</span>
                                                </div>
                                ...
                                <div>
                                    <div class="basic-product theme-product-1">
                                        <div class="overflow-hidden">
                                            <div class="img-wrapper">
                                                <a href="product-page(accordian).html"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/product/11.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                    <span>4.5</span>
                                                </div>
                                ...
                                <div>
                                    <div class="basic-product theme-product-1">
                                        <div class="overflow-hidden">
                                            <div class="img-wrapper">
                                                <a href="product-page(accordian).html"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/product/12.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                    <span>4.5</span>
                                                </div>
                                ...
                                <div>
                                    <div class="basic-product theme-product-1">
                                        <div class="overflow-hidden">
                                            <div class="img-wrapper">
                                                <a href="product-page(accordian).html"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/product/14.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                    <span>4.5</span>
                                                </div>
                                ...
                                <div>
                                    <div class="basic-product theme-product-1">
                                        <div class="overflow-hidden">
                                            <div class="img-wrapper">
                                                <a href="product-page(accordian).html"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/product/15.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                                <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                    <span>4.5</span>
                                                </div>
                                ...
                                <div>
                                    <div class="basic-product theme-product-1">
                                        <div class="overflow-hidden">
                                            <div class="img-wrapper">
                                                <a href="product-page(image-swatch).html">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/product/16.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <div class="rating-label"><i class="ri-star-s-fill"></i>
                                                    <span>4.5</span>
                ...
                <div class="slide-3 no-arrow slick-default-margin">
                    <div class="col-md-12">
                        <a href="#!">
                            <div class="classic-effect">
                                <div>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/blog/1.png"
                    ...
                    <div class="col-md-12">
                        <a href="#!">
                            <div class="classic-effect">
                                <div>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/blog/2.png"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                                <span></span>
                            </div>
                    ...
                    <div class="col-md-12">
                        <a href="#!">
                            <div class="classic-effect">
                                <div>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/fashion-1/blog/3.png"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                                <span></span>
                            </div>
