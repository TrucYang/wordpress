                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="product-slick">
                            <div><img src="<?php echo get_template_directory_uri(); ?>/assets/images/product-details/product/17.jpg" alt=""
                                    class="w-100 img-fluid blur-up lazyload"></div>
                            <div><img src="<?php echo get_template_directory_uri(); ?>/assets/images/product-details/product/18.jpg" alt=""
                                    class="w-100 img-fluid blur-up lazyload"></div>
                            <div><img src="<?php echo get_template_directory_uri(); ?>/assets/images/product-details/product/19.jpg" alt=""
                                    class="w-100 img-fluid blur-up lazyload"></div>
                            <div><img src="<?php echo get_template_directory_uri(); ?>/assets/images/product-details/product/18.jpg" alt=""
                                    class="w-100 img-fluid blur-up lazyload"></div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="product-page-details product-description-box sticky-details mt-0">
                            ...
                            <div class="trending-text ">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product-details/trending.gif" class="img-fluid" alt="">
                        ...
                        <div class="product-page-details product-form-box product-right-box d-flex
                            ...
                            <div class="variation-box size-box">
                                <ul class="image-box image">
                                    <li class="active">
                                        <a>
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product-details/product/17.jpg" alt="">
                                        </a>
                                    </li>

                                    <li>
                                        <a>
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product-details/product/20.jpg" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a>
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/product-details/product/21.jpg" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </div>
